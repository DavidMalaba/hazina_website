            ...
            <div class="lg:col-span-1 space-y-8">
                    ...
                    <ul class="space-y-6">
                        <li class="flex items-start gap-4">
                            ...
                            <div>
                                ...
                                <a href="mailto:contact@hazinahub.com" class="font-medium hover:text-emerald-300 transition">contact@hazinahub.com</a>
                            </div>
                        </li>
                        <li class="flex items-start gap-4">
                            <div class="w-10 h-10 bg-emerald-800 rounded-full flex items-center justify-center shrink-0">
                ...
                <div class="bg-white rounded-3xl p-8 shadow-sm border border-slate-100">
                    ...
                    <div class="flex gap-4">
                        <a href="#" class="w-10 h-10 bg-slate-100 rounded-full flex items-center justify-center text-slate-500 hover:bg-emerald-600 hover:text-white transition">
